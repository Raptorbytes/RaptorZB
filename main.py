# This is CLOSED SOURCE software, written by Raptorbytes LLC.

import os
import zipfile

print("Welcome to Arco's pathOwOgen Zip Bomb Factory!")
...
def zipper(payload_name = "pathOwOgen.md"):
    ...
    print(f"OwOgen Zip created: {zip_name} with {copies} files.")
