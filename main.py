...
while True:
    ...
    if str(".txt") or str(".md") in payload_name:
        break
    else:
...
# Original payload contents by default
# payload_contents = "Uh oh! Looks like you got a pathOwOgen! 
